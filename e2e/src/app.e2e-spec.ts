...
describe('new App', () => {
  ...
  describe('E2E tests', () => {
    ...
    it('allows editing of game 1', () => {
      app.navigateTo('team-details/1');
      app.navigateTo('game-details/1');
      var e = element(by.id('Edit-Game'));
      browser.wait(EC.presenceOf(e),10000);
      element(by.id('Edit-Game')).click();
      e = element(by.id('edit-title'));
      browser.wait(EC.presenceOf(e), 10000);
      expect(e.getText()).toEqual('Edit Game');
      var i = element(by.css('.input.ng-untouched.ng-pristine.ng-valid.ion-untouched.ion-pristine.ion-valid.sc-ion-input-md-h.sc-ion-input-md-s.has-value.hydrated .native-input.sc-ion-input-md'));
      browser.wait(EC.presenceOf(i),10000);
      i.click();
      i.sendKeys('The Team');
