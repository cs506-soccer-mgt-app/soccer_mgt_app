...
describe('new App', () => {
  ...
  describe('E2E tests', () => {
    ...
    it('allows editing of game 1', () => {
      app.navigateTo('team-details/1');
      app.navigateTo('game-details/1');
      var edit = element(by.id('Edit-Game'));
      browser.wait(EC.presenceOf(edit),10000);
      element(by.id('Edit-Game')).click();
      var e = element(by.id('edit-title'));
      browser.wait(EC.presenceOf(e), 10000);
      expect(e.getText()).toEqual('Edit Game');
      var i = element(by.css('.native-input.sc-ion-input-md'));
      browser.wait(EC.presenceOf(i),10000);
      i.click();
      i.sendKeys(Key.BACK_SPACE);
      i.sendKeys(Key.BACK_SPACE);
      i.sendKeys(Key.BACK_SPACE);
      i.sendKeys(Key.BACK_SPACE);
      i.sendKeys(Key.BACK_SPACE);
      ...
      browser.wait(EC.presenceOf(edit),5000);
      element(by.id('Edit-Game')).click();
      browser.wait(EC.presenceOf(e), 10000);
      expect(e.getText()).toEqual('Edit Game');
      browser.wait(EC.presenceOf(i),10000);
